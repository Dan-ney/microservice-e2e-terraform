...
apt-get update
apt-get upgrade -y
apt-get install -y wget curl gnupg2 apt-transport-https ca-certificates software-properties-common

# ─── Install Java ─────────────────────────────────────────
apt-get install -y openjdk-17-jdk

# ─── Install Jenkins ──────────────────────────────────────
# Download and add Jenkins GPG key correctly
...
# Wait for Jenkins to generate password
sleep 60
